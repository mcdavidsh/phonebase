...
class Gsm
{
    ...
    private $post_api= 'https://api.softhood.net/all/access/oauth/';
    ...
    function header()
    {
        $sitelogo = "core/assets/images/logo.png";
        ...
        if(!empty($getfile)){
            ...
            if ($getfile->siteurl == $siteUrl || basename($siteUrl) == 'index.php') {
            ...
            elseif (basename($siteUrl) == '404.html'){
                echo "<title>$getfile->sitename - $getfile->tagline</title>";
                echo '<link rel="canonical" href="' . $getfile->siteurl . '" />';
                //Google / Search Engine Tags
                echo '<meta itemprop="name" content="' . $getfile->sitename . '">';
              ...
              if (empty(file_get_contents($filename))) {
                  ...
                  if (isset($_POST['subscribe'])) {
                      ...
                      if (empty($site_name)) {
                          ...
                          }elseif (file_put_contents($filename, $json_arr) && !empty(file_get_contents($filename))) {
